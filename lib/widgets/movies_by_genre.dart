import 'package:cinelatino/screens/detail_screen.dart';
import 'package:eva_icons_flutter/eva_icons_flutter.dart';
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:cinelatino/bloc/get_movies_byGenre_bloc.dart';
  ...
  Widget _buildHomeWidget(MovieResponse data) {
    ...
    if (movies.length == 0) {
      ...
      pageController.addListener(() {
          //MoviesListByGenreBloc movieResponse = new MoviesListByGenreBloc();
        // if(pageController.position.pixels > pageController.position.maxScrollExtent)
          // moviesByGenreBloc..getMoviesByGenre(genreId);
          //movieResponse.getMoviesByGenre(this.genreId);
      });
