...
import 'package:cinelatino/bloc/get_persons_bloc.dart';
import 'package:cinelatino/model/person.dart';
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text("ACTORES DE LA SEMANA", style: TextStyle(
              ...
              child: GestureDetector(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text(((persons[index].known.toString() == 'Acting')?'Actor':'Director'),
                      maxLines: 2,
                      style: TextStyle(
                        height: 1.4,
                          color: Style.Colors.titleColor,
